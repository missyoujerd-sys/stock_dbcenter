...
const REMARK_OPTIONS = [
    ...
    'เครื่องหมดประกันไม่มีอะไหล่',
    'คลังไม่มีหมึกให้เบิกแล้ว',
    'เปลี่ยนมาใช้เครื่องเช่าแทน',
    'เมนบอร์ดไหม้ใช้งานไม่ได้',
    'อะไหล่ไม่มีจำหน่ายแล้ว',
    'จอเสื่อมสภาพจากการใช้งานนาน',
    'จอลายเป็นเส้นซ่อมไม่ได้',
    'เครื่องอายุมากไม่มีอะไหล่ขายแล้ว',
    'ซ่อมไม่คุ้มอะไหล่แพงพอๆกับซื้อเครื่องใหม่',
];
