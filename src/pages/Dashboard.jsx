            ...
            <div className="db-hero-banner mb-4">
                ...
                <div className="db-hero-title-block">
                    ...
                    <div className="db-hero-logo-wrap" style={{ 
                        ...
                        padding: '12px 20px', 
                        borderRadius: '20px', 
                        boxShadow: '0 10px 25px rgba(0,0,0,0.3), inset 0 2px 5px rgba(255,255,255,1)',
                        border: '1px solid rgba(255,255,255,0.5)',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center'
                    }}>
                        <img src="/cnkp-logo-best.png" alt="Nakornping Hospital Logo" style={{ height: '55px', objectFit: 'contain' }} />
                    </div>
                    <div>
