        ...
        <Card className="shadow-sm border-0">
            <Card.Header className="bg-white py-4 px-4 d-flex justify-content-between align-items-center border-0">
                <div className="d-flex align-items-center">
                    <h5 className="mb-0 text-dark fw-bold me-3">รายการพัสดุรอจำหน่าย</h5>
                    {selectedIds.length > 0 && (
                        <Button variant="danger" size="sm" onClick={handleShowBulkDistribute} className="rounded-pill px-3">
            ...
            <Card.Body className="p-0">
                <div className="table-responsive">
                    <Table hover className="mb-0 align-middle">
                        <thead>
                            <tr>
                                <th style={{ width: '60px' }} className="px-4">
                                    <Form.Check
                                        type="checkbox"
                                ...
                                <th className="py-3">วันที่สำรวจ</th>
                                <th>Asset ID</th>
                                <th>ยี่ห้อ/รุ่น</th>
                                <th>S/N</th>
                                <th>หน่วยงาน</th>
