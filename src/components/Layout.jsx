  ...
  return (
    <div className="d-flex flex-column min-vh-100 bg-light">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto mt-3 mt-lg-0">
              ...
              <Nav.Link
                as={Link}
                to="/incoming"
                className={`nav-link-custom ${location.pathname === "/incoming" ? "active" : ""}`}
              >
              ...
              <Nav.Link
                as={Link}
                to="/distribution"
                className={`nav-link-custom ${location.pathname === "/distribution" ? "active" : ""}`}
              >
              ...
              {isAdmin && (
                <Nav.Link
                  as={Link}
                  to="/inventory"
                  className={`nav-link-custom ${location.pathname === "/inventory" ? "active" : ""}`}
                >
      ...
      <footer className="bg-white text-center py-3 mt-4 border-top text-muted">
        <Container fluid>
          <small>
            &copy; {new Date().getFullYear()} ระบบจัดการ Stock พัสดุครุภัณฑ์
          </small>
        </Container>
      </footer>
    </div>
